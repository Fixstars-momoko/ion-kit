    ...
    ParamContainer(const std::string &k, Halide::Type t, int32_t d = 0)
        ...
        if (d == 0) {
            ...
            if (t.is_int()) {
                switch (t.bits()) {
                case 8:
                    i8_ = Halide::Param<int8_t>(k);
                    break;
                case 16:
                    i16_ = Halide::Param<int16_t>(k);
                    break;
                case 32:
                    i32_ = Halide::Param<int32_t>(k);
                    break;
                case 64:
                    i64_ = Halide::Param<int64_t>(k);
                    break;
                default:
                ...
                switch (t.bits()) {
                case 1:
                    b_ = Halide::Param<bool>(k);
                    break;
                case 8:
                    u8_ = Halide::Param<uint8_t>(k);
                    break;
                case 16:
                    u16_ = Halide::Param<uint16_t>(k);
                    break;
                case 32:
                    u32_ = Halide::Param<uint32_t>(k);
                    break;
                case 64:
                    u64_ = Halide::Param<uint64_t>(k);
                    break;
                default:
                    throw std::runtime_error("Unsupported type");
                }
                ...
                switch (t.bits()) {
                case 32:
                    f32_ = Halide::Param<float>(k);
                    break;
                case 64:
                    f64_ = Halide::Param<double>(k);
                    break;
                default:
                    throw std::runtime_error("Unsupported type");
                }
...
private:
    /**
      ...
      */
    Port(const std::string &k, const std::string &ni)
        : key_(k), type_(), dimensions_(0), node_id_(ni), param_info_(nullptr) {
    }
