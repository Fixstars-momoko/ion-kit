...
elseif(WIN32)
  set(HALIDE_LIBRARY_RELEASE ${HALIDE_ROOT}/Release/Halide.lib)
  set(HALIDE_LIBRARY_DEBUG ${HALIDE_ROOT}/Debug/Halide.lib)
  set(HALIDE_LIBRARY ${HALIDE_LIBRARY_RELEASE})
else()
