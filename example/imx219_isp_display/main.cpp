...
int main(int argc, char *argv[]) {
    ...
    for (int i = 0; i < num; ++i) {
        ...
        n = b.add("image_processing_bayer_downscale_uint16")(n["output"]).set_param(Param{"input_width", std::to_string(width_v)}, Param{"input_height", std::to_string(height_v)}, Param{"downscale_factor", "2"});
