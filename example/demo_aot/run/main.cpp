...
int main(int argc, char *argv[]) {
    try {
        ...
        pipeline(gain_b, gain_g, gain_r, gamma, offset_b, offset_g, offset_r, shading_correction_offset_b, shading_correction_offset_g, shading_correction_offset_r, shading_correction_slope_b, shading_correction_slope_g, shading_correction_slope_r, yolo_buf, depth_buf, sgm_buf);
