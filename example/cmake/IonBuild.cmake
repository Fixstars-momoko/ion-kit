...
function(ion_compile NAME)
    ...
    # Build compile
    add_executable(${NAME} ${IEC_SRCS} ${ION_BB_BB_SRCS})
    if(UNIX)
    ...
    add_custom_target(build SOURCES ${HEADER} ${STATIC_LIB})
endfunction()
...
function(ion_run NAME LIB_DIR PIPELINE_NAME)
    ...
    add_executable(${NAME} ${IER_SRCS} ${HEADER} ${ION_BB_RT_SRCS})
...
function(ion_jit NAME)
    ...
    add_executable(${NAME} ${IEJ_SRCS} ${ION_BB_BB_SRCS} ${ION_BB_RT_SRCS})
    if (UNIX)
        # For JIT compiling
